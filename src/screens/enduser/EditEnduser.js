...
class EditEnduser extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({id_fisik: enduser.fisik_pm_end_user_id});
    this.setState({id_enduser: enduser.pm_end_user_id});
    this.setState({id_checklist: enduser.checklist_end_user_devices_id});
    this.setState({id_hardware: enduser.hardware_detail_id});
    this.setState({viewDate: enduser.tanggal});
    this.setState({nama_teknisi: enduser.nama_teknisi});
    this.setState({jenis_perangkat: enduser.jenis_perangkat});
    this.setState({id_user: enduser.id_user});
    this.setState({nama_lengkap: enduser.nama_lengkap});
    this.setState({person_responsible: enduser.person_responsible});
    this.setState({divisi: enduser.divisi});
    this.setState({satuan_kerja: enduser.satuan_kerja});
    this.setState({lokasi: enduser.lokasi});
    this.setState({note: enduser.note});
    this.setState({merk: enduser.merek});
    this.setState({serialunit: enduser.serial_number});
    this.setState({seriallcd: enduser.lcd_serial_number});
    this.setState({serialmouse: enduser.mouse_serial_number});
    this.setState({serialkeyboard: enduser.keyboard_serial_number});
    this.setState({ip: enduser.ip_address});
    this.setState({username: enduser.user_login});
    this.setState({os: enduser.os});
    this.setState({officecheck: enduser.ms_office_check});
    this.setState({officenote: enduser.ms_office_note});
    this.setState({zipcheck: enduser.zip_check});
    this.setState({zipnote: enduser.zip_note});
    this.setState({browsercheck: enduser.web_browser_check});
    this.setState({browsernote: enduser.web_browser_note});
    this.setState({readercheck: enduser.adobe_reader_check});
    this.setState({readernote: enduser.adobe_reader_note});
    this.setState({forticheck: enduser.forti_check});
    this.setState({fortinote: enduser.forti_note});
    this.setState({kasperskycheck: enduser.kav_check});
    this.setState({kasperskynote: enduser.kav_note});
    this.setState({librecheck: enduser.libre_check});
    this.setState({librenote: enduser.libre_note});
    this.setState({sapcheck: enduser.sap_check});
    this.setState({sapnote: enduser.sap_note});
    this.setState({centralcheckingcheck: enduser.dc_check});
    this.setState({centralcheckingnote: enduser.dc_note});
    this.setState({cleaningcheck: enduser.hw_cleaning_check});
    this.setState({cleaningnote: enduser.hw_cleaning_note});
    this.setState({pcmonitorcheck: enduser.pc_monitor_notebook_check});
    this.setState({pcmonitornote: enduser.pc_monitor_notebook_note});
    this.setState({keymousecheck: enduser.keyboar_mouse_check});
    this.setState({keymousenote: enduser.keyboar_mouse_note});
    this.setState({labelcheck: enduser.label_check});
    this.setState({labelnote: enduser.label_note});
  }
  ...
  onSave = async () => {
    ...
    const pmEnduserId = this.state.id_enduser;
    const idHardware = this.state.id_hardware;
    const idFisik = this.state.id_fisik;
    const idChecklist = this.state.id_checklist;
    const PmEnduser = {
      ...
      checklist: {
        checklist_end_user_devices_id: idChecklist,
        pm_id: pmEnduserId,
    ...
    console.log('isi Enduser: ', PmEnduser);
    await updatePmEnduser(db, PmEnduser);
            ...
            <VStack space={2.5} w="100%" px="3">
              ...
              <Flex
                ...
                <TodoDescription
                  ...
                  value={this.state.kasperskynote}
                  onChangeText={event => {
                    this.setState({
                ...
                <TodoDescription
                  ...
                  value={this.state.centralcheckingnote}
                  onChangeText={event => {
                    this.setState({
                ...
                <TodoDescription
                  ...
                  value={this.state.pcmonitornote}
                  onChangeText={event => {
                    this.setState({
